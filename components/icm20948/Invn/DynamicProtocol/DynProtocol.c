...
const char * DynProtocol_sensorTypeToStr(int type)
{
	...
	case DYN_PRO_SENSOR_TYPE_OIS:                    return "OIS_0";
	case DYN_PRO_SENSOR_TYPE_OIS_1:                  return "OIS_1";
	...
	case DYN_PRO_SENSOR_TYPE_LOW_G:                  return "LOW_G";
	case DYN_PRO_SENSOR_TYPE_HIGH_G:                 return "HIGH_G";
	case DYN_PRO_SENSOR_TYPE_TAP:                    return "TAP";
	case DYN_PRO_SENSOR_TYPE_DATA_ENCRYPTION:        return "DATA_ENCRYPTION";
